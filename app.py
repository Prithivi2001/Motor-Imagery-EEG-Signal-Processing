...
global list_images, counter    

counter = -1
list_images = [
    ImageTk.PhotoImage(file = "images/picture_1.png"),
    ImageTk.PhotoImage(file = "images/picture_2.png"),
    ImageTk.PhotoImage(file = "images/picture_3.png")
]

exp_canvas = Canvas(root, width = 600, height = 600)
exp_canvas.pack(fill = "both", expand = True)

exp_canvas.create_image(0,0,image = list_images[0], anchor = "nw")

#new_label = Label(root, font = "italic")
#new_label.pack
def move():
    global counter
    if counter == 2:
        ...
        exp_canvas.create_image(0,0,image = list_images[counter + 1], anchor = "nw")
        counter+= 1
